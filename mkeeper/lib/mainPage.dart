...
import 'dart:io' show Platform; // 추가: 플랫폼 분리를 위해 사용
...
*/
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        _speak(
            "지도에서 길찾기를 하려면 위로 스와이프, 음성 상담을 받으시려면 아래로 스와이프 하세요. 앱을 종료하고 싶으시면 왼쪽으로 스와이프 하세요. 모든 설명을 다시 듣고 싶으시면 화면을 터치하세요");
      },
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                // 왼쪽에 이미지
                Transform.rotate(
                  angle: 90 * 3.14 / 180, // 0도 회전 (회전하지 않음)
            ...
            const SizedBox(height: 20), // 텍스트와 하단 이미지 간격 조절

            // 하단 이미지 (회전됨)
            Transform.rotate(
              angle: 0 * 3.14 / 180, // 180도 회전
              child: Image.asset(
                'asset/images/angle.png',
                width: 100,
                height: 100,
